...
import com.yalantis.ucrop.util.CustomLoader;
...
//    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.clickBack).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
        ...
        findViewById(R.id.clickDownload).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cropAndSaveImage();
            }
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mWrapperStateAspectRatio = (ViewGroup) findViewById(com.yalantis.ucrop.R.id.state_aspect_ratio);
        mWrapperStateAspectRatio.setOnClickListener(mStateClickListener);
        mWrapperStateRotate = (ViewGroup) findViewById(com.yalantis.ucrop.R.id.state_rotate);
        mWrapperStateRotate.setOnClickListener(mStateClickListener);
        mWrapperStateScale = (ViewGroup) findViewById(com.yalantis.ucrop.R.id.state_scale);
        mWrapperStateScale.setOnClickListener(mStateClickListener);

        mLayoutAspectRatio = (ViewGroup) findViewById(com.yalantis.ucrop.R.id.layout_aspect_ratio);
        mLayoutRotate = (ViewGroup) findViewById(com.yalantis.ucrop.R.id.layout_rotate_wheel);
        mLayoutScale = (ViewGroup) findViewById(com.yalantis.ucrop.R.id.layout_scale_wheel);
...
//        stateRotateImageView.setImageDrawable(new SelectedStateListDrawable(stateRotateImageView.getDrawable(), mActiveWidgetColor));
    ...
    private void setupRotateWidget() {
        mTextViewRotateAngle = ((TextView) findViewById(com.yalantis.ucrop.R.id.text_view_rotate));
    ...
    private void setupScaleWidget() {
        mTextViewScalePercent = ((TextView) findViewById(com.yalantis.ucrop.R.id.text_view_scale));
    ...
    protected void cropAndSaveImage() {
        CustomLoader.showProgressBar(UCropActivity.this, true);
        mBlockingView.setClickable(true);
//        mShowLoader = true;
//        supportInvalidateOptionsMenu();
